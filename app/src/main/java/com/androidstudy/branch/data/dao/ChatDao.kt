...
interface ChatDao {
    ...
    @Query("SELECT a.id, a.thread_id, a.user_id, a.body, a.timestamp, a.agent_id FROM MessageThread a WHERE thread_id =:thread_id GROUP BY body ORDER BY timestamp ASC")
