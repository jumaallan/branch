...
import com.androidstudy.branch.data.remote.UserAPI
...
class LoginActivity : AppCompatActivity() {
    ...
    private var authInterface: UserAPI? = null
    ...
    private fun setUp() {
        ...
        authInterface = retrofit.create(UserAPI::class.java)
    }
    ...
    private fun loginUser(username: String, pin: String) {
        ...
        val call = authInterface?.loginUser(user)
